...
var MatTab = class _MatTab {
  ...
  _stateChanges = new import_rxjs11.Subject();
  /**
...
var MatPaginatedTabHeader = class _MatPaginatedTabHeader {
  ...
  _stopScrolling = new import_rxjs11.Subject();
  /**
  ...
  ngAfterContentInit() {
    const dirChange = this._dir ? this._dir.change : (0, import_rxjs11.of)("ltr");
    const resize = this._sharedResizeObserver.observe(this._elementRef.nativeElement).pipe((0, import_operators9.debounceTime)(32), (0, import_operators9.takeUntil)(this._destroyed));
    const viewportResize = this._viewportRuler.change(150).pipe((0, import_operators9.takeUntil)(this._destroyed));
    const realign = () => {
    ...
    (0, import_rxjs11.merge)(dirChange, viewportResize, resize, this._items.changes, this._itemsResized()).pipe((0, import_operators9.takeUntil)(this._destroyed)).subscribe(() => {
      this._ngZone.run(() => {
  ...
  _itemsResized() {
    ...
    return this._items.changes.pipe(
      (0, import_operators9.startWith)(this._items),
      (0, import_operators9.switchMap)((tabItems) => new import_rxjs11.Observable((observer) => this._ngZone.runOutsideAngular(() => {
      ...
      (0, import_operators9.skip)(1),
      // Skip emissions where all the elements are invisible since we don't want
      // the header to try and re-render with invalid measurements. See #25574.
      (0, import_operators9.filter)((entries) => entries.some((e) => e.contentRect.width > 0 && e.contentRect.height > 0))
    );
  }
  ...
  _handlePaginatorPress(direction, mouseEvent) {
    ...
    this._stopInterval();
    (0, import_rxjs11.timer)(HEADER_SCROLL_DELAY, HEADER_SCROLL_INTERVAL).pipe((0, import_operators9.takeUntil)((0, import_rxjs11.merge)(this._stopScrolling, this._destroyed))).subscribe(() => {
      const {
        maxScrollDistance,
        distance
      } = this._scrollHeader(direction);
...
var MatTabBodyPortal = class _MatTabBodyPortal extends CdkPortalOutlet {
  ...
  _centeringSub = import_rxjs11.Subscription.EMPTY;
  /** Subscription to events for when the tab body finishes leaving from center position. */
  _leavingSub = import_rxjs11.Subscription.EMPTY;
  constructor() {
    super();
  }
  ...
  ngOnInit() {
    super.ngOnInit();
    this._centeringSub = this._host._beforeCentering.pipe((0, import_operators9.startWith)(this._host._isCenterPosition())).subscribe((isCentering) => {
...
var MatTabBody = class _MatTabBody {
  ...
  _dirChangeSubscription = import_rxjs11.Subscription.EMPTY;
...
var MatTabGroup = class _MatTabGroup {
  ...
  _changeDetectorRef = inject(ChangeDetectorRef);
  _ngZone = inject(NgZone);
  _tabsSubscription = import_rxjs11.Subscription.EMPTY;
  _tabLabelSubscription = import_rxjs11.Subscription.EMPTY;
  _tabBodySubscription = import_rxjs11.Subscription.EMPTY;
  _diAnimationsDisabled = _animationsDisabled();
  /**
  ...
  _subscribeToAllTabChanges() {
    this._allTabs.changes.pipe((0, import_operators9.startWith)(this._allTabs)).subscribe((tabs) => {
  ...
  _subscribeToTabLabels() {
    ...
    this._tabLabelSubscription = (0, import_rxjs11.merge)(...this._tabs.map((tab) => tab._stateChanges)).subscribe(() => this._changeDetectorRef.markForCheck());
  }
...
var MatTabNav = class _MatTabNav extends MatPaginatedTabHeader {
  ...
  _fitInkBarToContent = new import_rxjs11.BehaviorSubject(false);
  /** Whether tabs should be stretched to fill the header. */
  stretchTabs = true;
  get animationDuration() {
    return this._animationDuration;
  ...
  ngAfterContentInit() {
    this._inkBar = new MatInkBar(this._items);
    this._items.changes.pipe((0, import_operators9.startWith)(null), (0, import_operators9.takeUntil)(this._destroyed)).subscribe(() => this.updateActiveLink());
    super.ngAfterContentInit();
    this._keyManager.change.pipe((0, import_operators9.startWith)(null), (0, import_operators9.takeUntil)(this._destroyed)).subscribe(() => this._focusedItem.set(this._keyManager?.activeItem || null));
  }
  ngAfterViewInit() {
...
var MatTabLink = class _MatTabLink extends InkBarItem {
  ...
  constructor() {
    ...
    this._tabNavBar._fitInkBarToContent.pipe((0, import_operators9.takeUntil)(this._destroyed)).subscribe((fitInkBarToContent) => {
